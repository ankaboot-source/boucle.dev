...
Then proceed to plan generation directly. In CI mode (no user selection possible), default to the top 3–5 findings by leverage, ordered as in the table, and write plans for those. Do not stop to ask which findings to pursue.
