...
**CI mode:** Proceed directly with the task. Do not print a welcome message or wait for user input. Apply Emil Kowalski's design engineering philosophy to the current task and output the result.
